...
function imageNode1() {
  document.getElementById("image-thumbnail").src = "http://localhost/upload/image/imageNode1.jpeg"; 
...
function imageNode2() {
  document.getElementById("image-thumbnail").src = "http://localhost/upload/image/imageNode2.jpeg"; 
...
function imageNode3() {
  document.getElementById("image-thumbnail").src = "http://localhost/upload/image/imageNode3.jpeg"; 
